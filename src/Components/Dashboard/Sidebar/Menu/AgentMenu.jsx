...
import { FaHouseCircleCheck, FaHouseCircleExclamation } from "react-icons/fa6";
...
const AgentMenu = () => {
    ...
    return (
        <>
            ...
            <MenuItem icon={FaHouseCircleExclamation} label='My Requested Properties' address='requestedProperties' />
